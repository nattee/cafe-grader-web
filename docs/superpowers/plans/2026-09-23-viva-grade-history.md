...
class Viva::RegraderTest < ActiveSupport::TestCase
  ...
  test "revert refuses a batch whose problem no longer exists" do
    ...
    @problem.grounding_materials.clear                 # the fixture's HABTM join has an FK with no cascade
...
-# under the model (Task 4 render check ruling). Design:
-# docs/superpowers/specs/2026-09-23-viva-grade-history-design.md
