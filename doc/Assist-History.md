...
**study** · `doc/assist-corpus-eval-2026-09-03.md` (revs 2094, 2096, 2097); raw frame + scores + `frame2.rb`/`frame3.rb` + `judge.py`/`agreement.py`/`judge-*.csv` in `~/cafe-grader/assist-eval-2026-09-03/`
